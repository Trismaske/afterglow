...
Born from the 2026-08-21 audit (design phase of m0.8.7, prompted by the append-only duels decision).
...
| 3 | **Duel counts shrink** (editor un-review, external permanent removal, forget-card *both levels*) | Append-only duels, forget-erase anonymizes | Settled | **Shipped m0.8.7** |
