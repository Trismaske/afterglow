...
| docs/ImageCache_design.md | **Urgent m0.9 scoping input**: the app's on-device storage growth (image caches, suspected WAL bloat) — measured findings, the bounded-lifecycle-cache requirement, and the spikes that assign the gigabyte |
