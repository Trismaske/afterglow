...
T_IN, T_OLD, ADJ_MS, T_ADJ = 0.55, 0.60, 15 * 60 * 1000, 0.65
GAP_MS, BORDER_LO, MAX_CARDS = 3 * 60 * 1000, 0.35, 70
...
page = f'''<!doctype html><meta charset="utf-8"><title>Grouping study — round 3 (t=0.55 + adjacent merge)</title>
...
<h1>Round 3 · older photos (2020–2025) · {len(cards)} cards</h1>
